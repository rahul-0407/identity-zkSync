  ...
  return (
    <nav className="fixed top-0 left-0 z-500 flex w-full bg-[rgba(0,0,0,0)] items-center justify-between  border-b border-neutral-200 px-4 py-4 dark:border-neutral-800 backblur">
      ...
      {walletAddress ? (
        ...
        <button onClick={connect} className="w-24 transform rounded-lg bg-black px-6 py-2 font-medium text-white transition-all duration-300 md:w-32 dark:bg-[rgba(79,82,255,0.92)] dark:hover:bg-[rgba(68,51,255)] dark:text-white  box dark">
          {walletAddress ? shortAddress(walletAddress) : "Connect"}
        </button>
      )}
    </nav>
