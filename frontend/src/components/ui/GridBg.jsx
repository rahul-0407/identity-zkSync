...
function GridBackgroundDemo() {
  return (
    <div className="relative flex h-[86vh] w-full items-center justify-center  bg-black flex-col border-box ">
      <div
        className={cn(
          "absolute inset-0",
      ...
      <div className="flex-9 w-full border-4  border-neutral-950 z-100">
        <div className="h-full w-full border-1 border-gray-400 rounded-xl ">
          ...
          <button className="w-26 transform rounded-lg  px-6 py-3 font-medium  transition-all duration-300  md:w-45 bg-[rgba(79,82,255,0.92)] hover:bg-[rgba(68,51,255)] text-white  box dark">
            Get Started Now
          </button>
          </div>
        </div>
